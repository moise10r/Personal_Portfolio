...
const closedWind = document.querySelector('.card-popup-window .main-container .close');
...
arr.forEach((item) => {
  item.forEach((link) => {
    link.addEventListener('click', (e) => {
      ...
      const title = document.querySelector('.card-popup-window .main-container .title h2');
